...
public class MovieDisplayManager{
    ...
    /**
     * Displays the list of all available cinema movies. Basic information about each cinema movie is displayed.
     * For example, Title, showing status, movie type, overall reviewer rating and overall ticket sales.
    ...
    /**
     * Displays the list of top 5 ranking cinema movies.Top 5 movies are displayed in descending order
     * Top 5 movies can be ranked by overall reviewer rating or overall ticket sales. The ranking method is 
     * determined by app Admin. Basic info about each cinema movie is displayed.
     * For example, Title, showing status, movie type, overall reviewer rating and overall ticket sales.
    ...
    /**
     * Displays additional information of a particular cinema movie.
     * @param mList This is the list of all available cinema movies.
     */
